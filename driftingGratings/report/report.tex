...
% @Last Modified time: 2015-09-09 00:20:51
...
\subsubsection{Estimating the distribution response} % (fold)
\label{ssub:estimating_the_distribution_response}
...
Some Intuitions from the curves are
\begin{itemize}
...
\end{subfigure}
\end{figure}
% subsubsection estimating_the_distribution_response (end)
